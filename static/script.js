...
function compareResumes() {
  ...
  // const resumeText = encodeURIComponent(document.getElementById('resume').value);
  const jobDescriptionText = encodeURIComponent(document.getElementById('job-description').value);
  ...
  if (fileInput.files.length > 0) {
    ...
    // Append resumeText and jobDescriptionText as query parameters
